...
// reference AES encryption (128-bit block) - this is what we should emulate
void ref_aes_block_c(const byte* input, const byte* key, byte* output) {
